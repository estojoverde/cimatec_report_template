...
% \begin{filecontents}{CTConfigSection.cthlp}
% \documentclass[../../../../main.tex]{subfiles}
% \graphicspath{ {\subfix{../../../../CTsettings/figures/}} {./figures/} {../figures/} {../../figures/}}
...
% \input{../../../../CTConfigSection.cthlp}
% \input{CTConfigSection.cthlp}



% \input{CTsettings/DivisionAuxiliaries/section.cthlp}

\section{Monalisa Variant}

% \input{macros.lua}
% \mycustomsection{Monalisa Variant}

% \CTbeginSection{Monalisa Variant}
...
\begin{figure}[!htbp]
    \centering
    \begin{tikzpicture}
        % \node[rotate=45] {\includegraphics[width=0.5\textwidth]{Parts/PartExample/Chapters/potato_folder/figures/potato_monalisa_superior.jpg}}; %FULL PATH, avoid it! 
        \node[rotate=45] {\includegraphics[width=0.5\textwidth]{./figures/potato_monalisa_superior.jpg}};
    \end{tikzpicture}
